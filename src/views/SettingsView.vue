<template>
  <div class="p-6 space-y-6">
    <div>
      ...
      <p class="text-xs text-[var(--color-muted)] mt-1">Configure application and Docker engine connection</p>
    </div>
        ...
        <div class="space-y-4 text-xs text-gray-300 leading-relaxed">
          ...
          <div class="pt-2">
             <div class="flex items-start gap-2 bg-[var(--color-accent)]/5 border border-[var(--color-accent)]/20 p-3 rounded-lg">
               ...
               <p class="text-[10px] text-[var(--color-muted)]">
                 Changing the connection host will cause eDocker to attempt to reconnect immediately. If the connection fails, the app will show a blocking error screen.
               </p>
             </div>
          </div>
        </div>
